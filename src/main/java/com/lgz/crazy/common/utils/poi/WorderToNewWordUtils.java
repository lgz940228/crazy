...
public class WorderToNewWordUtils {
    ...
    private static Map<String, Integer> pictureType = new HashMap<>();
            ...
            PdfOptions pdfOptions = PdfOptions.create().fontProvider(new IFontProvider() {
                ...
                public com.lowagie.text.Font getFont(String familyName, String encoding, float size, int style, Color color) {
                    try {
                        ...
                        String fontPath = PoiTestController.class.getResource("/").getPath() + "poi" + File.separator + "SimSun.ttf";
        ...
        for (XWPFParagraph paragraph : paragraphs) {
            ...
            if(checkText(text)) {
                ...
                for (XWPFRun run : runs) {
                    ...
                    String value = changeValue(runStr,textMap);
                    run.setText(value,0);
                }
            }
        }
